...
def SSRN_model_fn(features, labels, mode):
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
	    ...
	    summary_hook = tf.train.SummarySaverHook(
		    save_steps  =128,
		    output_dir = "IN_model/summary/train",
...
##def scenario(All_features_, All_labels, indices):
##    
...
##                                                                                                                                                           
##        collection = [1, 4, 7, 8, 9, 12, 13, 14, 15, 16]
##        for L in  range(1,17):
##            count = 0;
...
##            y_val_verylow = y_val
##        
##    spio.savemat('data/IN/allLabels/y_train.mat', {"y_train" : y_train_original})
##    spio.savemat('data/IN/allLabels/y_val.mat', {"y_val" : y_val_original})
##
##    spio.savemat('data/IN/allLabels/X_train_original.mat', {"X_train_original" : X_train_original})
##    spio.savemat('data/IN/allLabels/X_train_high.mat', {"X_train_high" : X_train_high})
##    spio.savemat('data/IN/allLabels/X_train_medium.mat', {"X_train_medium" : X_train_medium})
##    spio.savemat('data/IN/allLabels/X_train_low.mat', {"X_train_low" : X_train_low})
##    spio.savemat('data/IN/allLabels/X_train_verylow.mat', {"X_train_verylow" : X_train_verylow})
##    
##    spio.savemat('data/IN/allLabels/X_val_original.mat', {"X_val_original" : X_val_original})
##    spio.savemat('data/IN/allLabels/X_val_high.mat', {"X_val_high" : X_val_high})
##    spio.savemat('data/IN/allLabels/X_val_medium.mat', {"X_val_medium" : X_val_medium})
##    spio.savemat('data/IN/allLabels/X_val_low.mat', {"X_val_low" : X_val_low})
##    spio.savemat('data/IN/allLabels/X_val_verylow.mat', {"X_val_verylow" : X_val_verylow})
...
##    spio.savemat('data/IN/allLabels/y_train.mat',{"y_train":y_train_final})
##    spio.savemat('data/IN/allLabels/X_train.mat',{"X_train":X_train_final})
...
##    scenario(All_features_, All_labels, indices)
    (X_train, y_train) = makeTrainingSet(indices)
    
##    mat = spio.loadmat('data/IN/allLabels/X_train.mat', squeeze_me = True)                                                                                         
##    X_train = mat['X_train']
##    mat = spio.loadmat('data/IN/allLabels/y_train.mat', squeeze_me = True)                                                                                         
##    y_train = mat['y_train']
