...
def scenario(All_features_, All_labels):
    ...
    spio.savemat('data/KSC/allLabels/y_train.mat', {"y_train" : y_train_original})
    spio.savemat('data/KSC/allLabels/y_val.mat', {"y_val" : y_val_original})

    spio.savemat('data/KSC/allLabels/X_train_original.mat', {"X_train_original" : X_train_original})
    spio.savemat('data/KSC/allLabels/X_train_high.mat', {"X_train_high" : X_train_high})
    spio.savemat('data/KSC/allLabels/X_train_medium.mat', {"X_train_medium" : X_train_medium})
    spio.savemat('data/KSC/allLabels/X_train_low.mat', {"X_train_low" : X_train_low})
    spio.savemat('data/KSC/allLabels/X_train_verylow.mat', {"X_train_verylow" : X_train_verylow})
    
    spio.savemat('data/KSC/allLabels/X_val_original.mat', {"X_val_original" : X_val_original})
    spio.savemat('data/KSC/allLabels/X_val_high.mat', {"X_val_high" : X_val_high})
    spio.savemat('data/KSC/allLabels/X_val_medium.mat', {"X_val_medium" : X_val_medium})
    spio.savemat('data/KSC/allLabels/X_val_low.mat', {"X_val_low" : X_val_low})
    spio.savemat('data/KSC/allLabels/X_val_verylow.mat', {"X_val_verylow" : X_val_verylow})
        

def makeTrainingSet(indices):
    mat = spio.loadmat('data/KSC/allLabels/X_train_original.mat', squeeze_me = True)                                                                                         
    X_train_original = mat['X_train_original']
    mat = spio.loadmat('data/KSC/allLabels/X_train_high.mat', squeeze_me = True)                                                                                         
    X_train_high = mat['X_train_high']
    mat = spio.loadmat('data/KSC/allLabels/X_train_medium.mat', squeeze_me = True)                                                                                         
    X_train_medium = mat['X_train_medium']
    mat = spio.loadmat('data/KSC/allLabels/X_train_low.mat', squeeze_me = True)                                                                                         
    X_train_low = mat['X_train_low']
    mat = spio.loadmat('data/KSC/allLabels/X_train_verylow.mat', squeeze_me = True)                                                                                         
    X_train_verylow = mat['X_train_verylow']
    
    mat = spio.loadmat('data/KSC/allLabels/y_train.mat', squeeze_me = True)                                                                                         
    y_train = mat['y_train']
...
##    spio.savemat('data/KSC/allLabels/y_train.mat',{"y_train":y_train_final})
##    spio.savemat('data/KSC/allLabels/X_train.mat',{"X_train":X_train_final})
...
##    mat = spio.loadmat('data/KSC/allLabels/X_train.mat', squeeze_me = True)                                                                                         
##    X_train = mat['X_train']
##    mat = spio.loadmat('data/KSC/allLabels/y_train.mat', squeeze_me = True)                                                                                         
##    y_train = mat['y_train']
    mat = spio.loadmat('data/KSC/allLabels/X_val_original.mat', squeeze_me = True)                                                                                         
    X_val = mat['X_val_original']
    mat = spio.loadmat('data/KSC/allLabels/y_val.mat', squeeze_me = True)                                                                                         
    y_val = mat['y_val']
