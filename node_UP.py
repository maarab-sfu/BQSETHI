...
mat = spio.loadmat('data/UP/allLabels/X_val_high.mat', squeeze_me = True)                                                                                         
X_val_high = mat['X_val_high']

mat = spio.loadmat('data/UP/allLabels/X_val_medium.mat', squeeze_me = True)                                                                                         
X_val_medium = mat['X_val_medium']

mat = spio.loadmat('data/UP/allLabels/X_val_low.mat', squeeze_me = True)                                                                                         
X_val_low = mat['X_val_low']

mat = spio.loadmat('data/UP/allLabels/X_val_verylow.mat', squeeze_me = True)                                                                                         
...
##pickle.dump( lossMat, open( "data/UP/allLabels/lossMat.file", "wb" ) )
...
##    with open( "data/UP/allLabels/lossMat.file", "rb" ) as f:
