...
def SSRN_model_fn(features, labels, mode):
    ...
    input_layer_spectral = features["x"]
    print("input shape: ", input_layer_spectral.shape)
    input_layer_spectral = tf.transpose(input_layer_spectral, perm= [0, 3, 1, 2])
    print("input shape: ", input_layer_spectral.shape)
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
	    ...
	    summary_hook = tf.train.SummarySaverHook(
		    save_steps  =128,
		    output_dir = "UP_model_ReducedClasses/summary/train",
...
def scenario(All_features_, All_labels):
    ...
    spio.savemat('data/UP/selectedLabels/y_train.mat', {"y_train" : y_train_original})
    spio.savemat('data/UP/selectedLabels/y_val.mat', {"y_val" : y_val_original})

    spio.savemat('data/UP/selectedLabels/X_train_original.mat', {"X_train_original" : X_train_original})
    spio.savemat('data/UP/selectedLabels/X_train_high.mat', {"X_train_high" : X_train_high})
    spio.savemat('data/UP/selectedLabels/X_train_medium.mat', {"X_train_medium" : X_train_medium})
    spio.savemat('data/UP/selectedLabels/X_train_low.mat', {"X_train_low" : X_train_low})
    spio.savemat('data/UP/selectedLabels/X_train_verylow.mat', {"X_train_verylow" : X_train_verylow})
    
    spio.savemat('data/UP/selectedLabels/X_val_original.mat', {"X_val_original" : X_val_original})
    spio.savemat('data/UP/selectedLabels/X_val_high.mat', {"X_val_high" : X_val_high})
    spio.savemat('data/UP/selectedLabels/X_val_medium.mat', {"X_val_medium" : X_val_medium})
    spio.savemat('data/UP/selectedLabels/X_val_low.mat', {"X_val_low" : X_val_low})
    spio.savemat('data/UP/selectedLabels/X_val_verylow.mat', {"X_val_verylow" : X_val_verylow})
        

def makeTrainingSet(indices):
    mat = spio.loadmat('data/UP/selectedLabels/X_train_original.mat', squeeze_me = True)                                                                                         
    X_train_original = mat['X_train_original']
    mat = spio.loadmat('data/UP/selectedLabels/X_train_high.mat', squeeze_me = True)                                                                                         
    X_train_high = mat['X_train_high']
    mat = spio.loadmat('data/UP/selectedLabels/X_train_medium.mat', squeeze_me = True)                                                                                         
    X_train_medium = mat['X_train_medium']
    mat = spio.loadmat('data/UP/selectedLabels/X_train_low.mat', squeeze_me = True)                                                                                         
    X_train_low = mat['X_train_low']
    mat = spio.loadmat('data/UP/selectedLabels/X_train_verylow.mat', squeeze_me = True)                                                                                         
    X_train_verylow = mat['X_train_verylow']
    
    mat = spio.loadmat('data/UP/selectedLabels/y_train.mat', squeeze_me = True)                                                                                         
    y_train = mat['y_train']
...
##    spio.savemat('data/UP/selectedLabels/y_train.mat',{"y_train":y_train_final})
##    spio.savemat('data/UP/selectedLabels/X_train.mat',{"X_train":X_train_final})
    return (X_train_final, y_train_final)

def main(unused_argv):

    mat = spio.loadmat('data/UP/selectedLabels/indices.mat', squeeze_me = True)                                                                                         
    indices = mat['indices']
...
##    mat = spio.loadmat('data/UP/selectedLabels/X_train.mat', squeeze_me = True)                                                                                         
##    X_train = mat['X_train']
##    mat = spio.loadmat('data/UP/selectedLabels/y_train.mat', squeeze_me = True)                                                                                         
##    y_train = mat['y_train']
    mat = spio.loadmat('data/UP/selectedLabels/X_val_original.mat', squeeze_me = True)                                                                                         
    X_val = mat['X_val_original']
    mat = spio.loadmat('data/UP/selectedLabels/y_val.mat', squeeze_me = True)                                                                                         
    y_val = mat['y_val']
    ...
    SSRN_classifier = tf.estimator.Estimator(model_fn = SSRN_model_fn, model_dir = "UP_model_ReducedClasses/", config = tf.contrib.learn.RunConfig(
