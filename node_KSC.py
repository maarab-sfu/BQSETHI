...
mat = spio.loadmat('data/KSC/allLabels/X_val_high.mat', squeeze_me = True)                                                                                         
X_val_high = mat['X_val_high']

mat = spio.loadmat('data/KSC/allLabels/X_val_medium.mat', squeeze_me = True)                                                                                         
X_val_medium = mat['X_val_medium']

mat = spio.loadmat('data/KSC/allLabels/X_val_low.mat', squeeze_me = True)                                                                                         
X_val_low = mat['X_val_low']

mat = spio.loadmat('data/KSC/allLabels/X_val_verylow.mat', squeeze_me = True)                                                                                         
...
##pickle.dump( lossMat, open( "data/IN/allLabels/lossMat.file", "wb" ) )
...
##    with open( "data/IN/allLabels/lossMat.file", "rb" ) as f:
